...
TEST_FILETYPES = ['mesh.refined.obj', 'mesh.refined.mtl', 'mesh.refined_0.png', 'sequence.zip']
...
FILETYPES = TEST_FILETYPES + ['labels.instances.annotated.ply', 'mesh.refined.0.010000.segs.json', 'semseg.json']
